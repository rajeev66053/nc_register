 ...
 <div class="row-fluid" style="min-height: 220px; width: 1000px; margin-left: 10px;">
      <div class="box span12"  style="margin: 40px;">
            ...
            <div class="box-header well">
                    <h2><i class="icon-bookmark"></i>NC Commit</h2>
            ...
            <div class="box-content" style="min-height: 220px;">
                    ...
                    <table  style="width: 99%; margin-left: 5px;" class="table table-striped table-bordered table-condensed bootstrap-datatable datatable index_table">
                        ...
                        <?php if(isset($forward_log)){ ?>  
						  <tr>
                            <td><label  class="control-label" for="ref_num">Forward Reason</label></td>
                            <td> <?php echo $forward_log[0]['comment']; ?></td>
                          </tr>
						  <?php } ?>
                ...
                <button type="button" id="reject"  data-toggle="modal" data-target="#acceptModal">Accept</button>
                <button type="button" id="reject" data-toggle="modal" data-target="#rejectModal">Reject</button>
                <button type="button" id="forwqard"  data-toggle="modal" data-target="#forwardModal">Forward</button>
				
				
               </div>
        </div>

 <div class="nc_ticket_form">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="control-group">
                        ...
                        <input type="hidden" name="ticket_id"  value="<?php echo $ticket[0]['id']?>"/>
